...
const CharacterSelectorModal: React.FC<CharacterSelectorModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
            <div
                ref={modalRef}
                className="w-full max-w-2xl bg-gray-900/80 border border-violet-500/50 rounded-lg shadow-xl flex flex-col"
            >
                <div className="p-4 border-b border-violet-500/30">
                    <h2 className="text-xl font-bold text-cyan-400">Choose Your Voice</h2>
                    <p className="text-sm text-gray-400">Select who is speaking.</p>
                </div>
                ...
                <div className="p-4">
                    <div className="relative">
                        <input
                            ...
                            placeholder="Search characters by name or epithet..."
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 max-h-[60vh] overflow-y-auto">
